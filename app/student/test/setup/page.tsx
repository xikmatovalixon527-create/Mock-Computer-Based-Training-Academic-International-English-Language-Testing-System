    ...
    <Navbar>
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white uppercase tracking-wider">Exam Configuration</h1>
            <p className="text-xs text-neutral-400 uppercase tracking-wider mt-0.5">Standard Academic IELTS timed writing test</p>
          </div>
        </div>

        <div className="bg-neutral-950 border border-neutral-900 rounded-lg p-6 space-y-6">
          <div className="space-y-3">
            <label className="block text-xs uppercase tracking-wider font-semibold text-neutral-400">Select Exam Format</label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                >
                  ...
                  <div className="space-y-1 text-xs text-neutral-400 font-semibold font-mono">
                    <div className="flex items-center gap-1.5"><Clock className="w-3.5 h-3.5 text-neutral-400" /> {opt.time}</div>
                    <div className="flex items-center gap-1.5"><BookOpen className="w-3.5 h-3.5 text-neutral-400" /> {opt.min}</div>
                  </div>
                </button>
              ))}
            </div>
